...
SECRET_KEY = 'django-insecure-axhvtmc&694o$dykyj+5t9^m5yd%v&eq&_jzr8+njmg2hg2m5r'
...
#for getting user uploaded media files in the media folder in the project directory